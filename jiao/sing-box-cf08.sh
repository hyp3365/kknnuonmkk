...
install_singbox() {
    ...
    latest_version=$(curl -s "https://api.github.com/repos/hyp3699/kknnuonmkk/releases" | jq -r '[.[] | select(.prerelease==false) | select(.tag_name | contains("sing-box-") and contains("-v2rayapi"))][0].tag_name')
