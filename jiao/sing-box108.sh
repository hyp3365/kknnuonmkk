...
cf_select_auth() {
    ...
    echo -e " \033[33mCloudflare One / Zero Trust(区域) Argo Tunnel (Legacy)(区域)\033[0m，权限设为 \033[32m全部\033[0m"
...
issue_cf_token_cert() {
    ...
    echo -e " \033[33mDNS & Zones(区域) DNS\033[0m，权限设为 \033[32mEdit (编辑)\033[0m"
    echo -e " \033[33mDNS & Zones(区域) Zone Settings (区域设置)\033[0m，权限设为 \033[32mEdit (编辑)\033[0m"
    echo -e " \033[33mRules & Rules & Configuration(区域) Origin (源站)\033[0m，权限设为 \033[32mEdit (编辑)\033[0m"	
