...
const UUID = process.env.UUID || '81c15dc9-5fe9-44d0-937c-896982e5fa79'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'nennnsssn.xct.de5.net:443';       // 哪吒v1填写形式：nz.abc.com:8008   哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '';           // 哪吒v1没有此变量，v0的agent端口为{443,8443,2096,2087,2083,2053}其中之一时开启tls
const NEZHA_KEY = process.env.NEZHA_KEY || 'xfh9ScsRhOXKRkxHeOnq2ECMBIU2IeLf';             // v1的NZ_CLIENT_SECRET或v0的agent端口                
...
const SUB_PATH = process.env.SUB_PATH || 'hypsspsaos22563';            // 获取节点的订阅路径
const NAME = process.env.NAME || '';                       // 节点名称
const PORT = process.env.PORT || 31284;                     // http和ws服务端口
